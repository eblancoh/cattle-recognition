...
def VGG16(include_top=True, weights='vggface',
    ...
    if weights == 'vggface':
        if include_top:
            weights_path = get_file('vggface_tf_vgg16.h5',
                                    utils.
                                    VGG16_WEIGHTS_PATH,
                                    cache_subdir=utils.VGGFACE_DIR)
        else:
            weights_path = get_file('vggface_tf_notop_vgg16.h5',
...
def RESNET50(include_top=True, weights='vggface',
    ...
    if weights == 'vggface':
        if include_top:
            weights_path = get_file('vggface_tf_resnet50.h5',
                                    utils.RESNET50_WEIGHTS_PATH,
                                    cache_subdir=utils.VGGFACE_DIR)
        else:
            weights_path = get_file('vggface_tf_notop_resnet50.h5',
...
def SENET50(include_top=True, weights='vggface',
    ...
    if weights == 'vggface':
        if include_top:
            weights_path = get_file('vggface_tf_senet50.h5',
                                    utils.SENET50_WEIGHTS_PATH,
                                    cache_subdir=utils.VGGFACE_DIR)
        else:
            weights_path = get_file('vggface_tf_notop_senet50.h5',
